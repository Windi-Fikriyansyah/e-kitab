...
.total-box {
    background-color: #f8f9fa; /* Warna kotak */
    border: 2px solid #007bff; /* Border biru */
    border-radius: 10px; /* Sudut melengkung */
    padding: 20px 40px; /* Ruang di dalam kotak */
    text-align: center;
...
.total-box .amount {
    font-size: 28px; /* Ukuran font total */
    font-weight: bold;
    color: #007bff; /* Warna teks total */
    margin-left: 10px; /* Jarak antara label dan total */
}
...
.search-container {
        ...
        justify-content: center;
        align-items: center;
        backdrop-filter: blur(5px); /* Add slight blur effect to background */
    }
                ...
                <div class="card">
                    ...
                    <div class="payment-section">
                        <div>
                            ...
                            <input type="text" id="paymentAmount" class="payment-input" placeholder="Masukkan Nominal Pembayaran" oninput="formatCurrency(this)">
                        </div>
                        <div>
                            <label for="changeAmount">Kembalian:</label>
                            <input type="text" id="changeAmount" class="payment-input" placeholder="Kembalian" disabled>
                        </div>
...
document.getElementById('searchInput').addEventListener('keyup', function(e) {
    ...
    searchTimeout = setTimeout(() => {
        ...
        function updateQuantity(productId, newQuantity) {
            ...
            cart = cart.map(item => item.id === productId ? { ...item, quantity: parseInt(newQuantity) } : item);
            renderCart();
        }
